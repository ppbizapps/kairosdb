...
public class SoftAuthModule extends org.eclipse.jetty.jaas.spi.AbstractLoginModule
{
    ...
    //PropertyFile Login Module Properties begin
    ...
    //LDAPLoginModule Properties begin
    /**
    ...
    private boolean loginSoft(String webUserName, Object webCredential)
    {
        if (webUserName.equals("") && webCredential.equals(""))
        {
            setAuthenticated(true);
            List<String> roles  = new ArrayList<>();
            UserInfo userInfo = new UserInfo("DefaultiestUser", null, roles);
    ...
    private boolean loginFileProperty(String webUserName, Object webCredential) throws Exception
    {
        UserInfo userInfo = getUserInfoPropertyFile(webUserName);
        ...
        {
            JAASUserInfo jaasUser = new JAASUserInfo(userInfo);
            setAuthenticated(jaasUser.checkCredential(webCredential));
            if(!isAuthenticated())
                return false;
            setCurrentUser(jaasUser);
            return true;
        }
    }
    ...
    public boolean login() throws LoginException
    {
        try
        {
            ...
            boolean authed = loginSoft(webUserName, webCredential);

            if(!authed)
                authed = loginFileProperty(webUserName, webCredential);
    ...
    public UserInfo getUserInfoPropertyFile(String userName) throws Exception
    {
